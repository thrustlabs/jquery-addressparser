...
(function() {
  ...
  describe('Address Parser', function() {
    it('should extract the name', function() {
      var expectedValue, sut;
      expectedValue = 'John Smith';
      sut = new AddressParser;
      sut.parse('John Smith, 121 John St., Toronto, Ontario');
      return expect(sut.name).toEqual(expectedValue);
    });
    it('should extract the email', function() {
      var expectedValue, sut;
      expectedValue = 'bob@smith.com';
      sut = new AddressParser;
      sut.parse('John Smith, 121 John St., Toronto, Ontario, bob@smith.com');
      return expect(sut.email).toEqual(expectedValue);
    });
    it('should reformat North American phone numbers', function() {
      var expectedValue, sut;
      expectedValue = '(416) 967-1111';
      sut = new AddressParser;
      sut.parse('John Smith, 416.967 1111');
      return expect(sut.phone).toEqual(expectedValue);
    });
    it('should prefix URLs with http://', function() {
      var expectedValue, sut;
      expectedValue = 'http://www.thrustlabs.com';
      sut = new AddressParser;
      sut.parse('John Smith, www.thrustlabs.com');
      return expect(sut.website).toEqual(expectedValue);
    });
    it('should extract the full address', function() {
      var sut;
      sut = new AddressParser;
      ...
      return expect(sut.country).toEqual('Canada');
    });
    it('should parse the Amsterdam brewery', function() {
      var address, sut;
      address = "Amsterdam Brewery\ninfo@amsterdambeer.com\n416.504.6882\nhttp://amsterdambeer.com\n45 Esandar Dr Toronto, ON M4G 4C5‎";
      sut = new AddressParser;
      sut.parse(address);
      ...
      return expect(sut.phone).toEqual('(416) 504-6882');
    });
    it('should parse Secco Italian Bubbles', function() {
      var address, sut;
      address = "Secco Italian Bubbles\n19 East Birch Street, Ste 106\nWalla Walla, Washington 99362\nPhone: 509.526.5230 \nseccoitalianbubbles@gmail.com \n\nhttp://www.seccobubbles.com/   ";
      sut = new AddressParser;
      sut.parse(address);
      ...
      return expect(sut.phone).toEqual('(509) 526-5230');
    });
    it('should parse Saltwater Farm', function() {
      var address, sut;
      address = "Saltwater Farm Vineyard\n349 Elm St  Stonington, Connecticut 06378  ";
      sut = new AddressParser;
      sut.parse(address);
      ...
      return expect(sut.phone).toEqual('');
    });
    return it('should parse Chamard Vineyards', function() {
      var address, sut;
      ...
      expect(sut.country).toEqual('USA');
      expect(sut.website).toEqual('');
      return expect(sut.phone).toEqual('(860) 664-0299');
    });
  });
